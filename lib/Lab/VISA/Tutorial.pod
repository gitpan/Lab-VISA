...
Lab::VISA and its related packages allow to perform test and measurement
...
The lowest level is C<Lab::VISA>. It makes the NI-VISA library accessible
from perl and therefor allows to make any standard VISA call.

The modules in the C<Lab::Instrument> package make communication with
instruments easier by silently handling the protocol involved.

Package C<Lab::Tools> is the highest abstraction layer. These modules
...
level modules from the C<Lab::Instrument> package requires almost no knowledge
...
directory of the Lab::VISA package.
...
The Lab::Instrument class can do for us the routine work of connecting to certain
instrument.
...
By only using C<Lab::Instrument> you should already be able to do about
...
The virtual instrument classes in the C<Lab::Instrument> package attempt to
...
L<Lab::Instrument::Source|Lab::Instrument::Source> module for details.
...
L<Lab::Instrument::HP34401A|Lab::Instrument::HP34401A>, the driver for a
...
C<-E<gt>id> method that returns the instrument's id string again.

TODO: Examples for C<Lab::Instrument::Source>
...
has shown that the C<Lab::Tools> modules will help you to keep track of this
...
is maintained by the L<Lab::Data::Meta|Lab::Data::Meta> class and is usually
...
elements which are defined in L<Lab::Data::Meta|Lab::Data::Meta>. The most
...
available fields is given in the L<Lab::Data::Meta|Lab::Data::Meta> manpage.

=head3 block

The example data above was aquired in two traces or scans or sweeps, which are
separated by an empty line in the I<data> file now. C<Lab::Data::Meta>
...
L<Lab::Data::Meta|Lab::Data::Meta> and L<Lab::Measurement|Lab::Measurement>
manpages.
...
plotted with a single command, using the L<Lab::Data::Plotter|Lab::Data::Plotter> module
and the script C<plotter.pl>. Because all the necessary information is stored in
the I<meta> file, these plots will B<automatically contain the right axes, ranges, labels,
...
L<Lab::Measurement|Lab::Measurement> module, you can display any of these plots live,
...
The L<Lab::Measurement|Lab::Measurement> class makes it easy to write a measurement
script that takes advantage of the meta data system introduced above...

=head2 Examples

=head3 Example 2D mit Measurement
...
=head3 Beispiel for plotter.pl

=head3 Example mit nur Writer
...
This is $Id: Tutorial.pod 511 2006-09-25 19:03:36Z schroeer $
